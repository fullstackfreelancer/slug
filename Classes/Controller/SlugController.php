 ...
 */
class SlugController extends ActionController {
    ...
    /**
     * Generates the list view of custom records with filtering options.
     *
     * Provides various filter options, assigns necessary variables to the view,
     * and renders the 'Record' template.
     *
     * @return ResponseInterface Rendered response for the 'Record' template.
     */
    protected function recordAction(): ResponseInterface
    {
        ...
        return $view->renderResponse('Record');
    }
